"""
evaluate_pqc_ddpg.py

Evaluates a trained PQC-DDPG market making agent using saved actor weights.
...
def evaluate(model_path_actor, episodes=5):
    ...
    print("\n PQC-DDPG Evaluation Summary:")
    print(f"Average Reward: {np.mean(all_rewards):.2f}")
    print(f"Average Final Inventory: {np.mean(all_inventory):.2f}")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate a trained PQC-DDPG agent.")
